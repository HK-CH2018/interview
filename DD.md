- [1 路径规划稳定性提升](#1-路径规划稳定性提升)
  - [1.1 总体设计框架](#11-总体设计框架)
  - [1.2 A算子批量拆分od对，每100个od对作为一次请求的上限](#12-a算子批量拆分od对每100个od对作为一次请求的上限)
  - [1.3 B / C 算子：并行算路（V1 \& V2）,并行框架](#13-b--c-算子并行算路v1--v2并行框架)
  - [1.4 Merge 算子：结果兜底合并](#14-merge-算子结果兜底合并)
  - [1.5 亮点](#15-亮点)
  - [1.6 难点](#16-难点)
- [2](#2)
